<template>
  ...
  <div id="right-panel" class="right-panel">
              ...
              <form>
                ...
                >
                  <select class="form-control" style="width: 350px">
                    <option>Rechercher un poste comptable</option>
                    <option
                      v-for="(bourse, index) in this.store
    ...
    <div
      class="content mt-3"
      v-if="
        this.store.clicked_attributions || this.store.clicked_renouvellements
      "
    >
      <h4 style="padding-left: 18px" v-if="this.store.clicked_attributions">
        Statistiques des attributions global
      </h4>
      <h4 style="padding-left: 18px" v-if="this.store.clicked_renouvellements">
        Statistiques des renouvellements global
      </h4>
      <hr />
    ...
    <div class="content mt-3">
      ...
      <div class="col-md-12" v-if="this.store.clicked_attributions">
        <div class="card">
          <table
            id="table_bourse"
